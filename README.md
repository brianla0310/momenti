...
- **Monthly / weekly diary** — a decoratable monthly spread + a week strip for navigation, following the browser's current local month, with **past navigation** (view-aware prev/next arrows — months in month view, ±7-day weeks in week view — an `Oggi` button, and a month/year picker) to revisit saved past months and weeks; the future stays out of reach
